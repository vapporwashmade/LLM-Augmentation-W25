    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "rooms": {
                    "type": "number",  # Number of rooms
                    "description": "Number of rooms requested (1-9, default=1)."
                },
                "price_range": {
                    "type": "string",  # Price range in USD
                    "description": "Filter hotel offers by price range (e.g., '200-300' or '-300')."
                }
            },
